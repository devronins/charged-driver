...
export const updateService = (id: string, data: any) =>
  axiosInstance.put(`/v1/service/update/${id}`, data);
...
export const updateProperty = (id: string, data: any) =>
  axiosInstance.put(`/v1/property/update/${id}`, data);
...
export const updateUser = (id: string, data: any) =>
  axiosInstance.put(`/v1/user/update/${id}`, data);
...
export const updateCategory = (id: string, data: any) =>
  axiosInstance.put(`/v1/category/update/${id}`, data);
...
export const updateEvent = (id: string, data: any) =>
  axiosInstance.put(`/v1/event/update/${id}`, data);
...
export const updateRoom = (id: string, data: any) =>
  axiosInstance.put(`/v1/room/update/${id}`, data);
...
export const updateAbout = (id: string, data: any) =>
  axiosInstance.put(`/v1/about/update/${id}`, data);
...
export const updateExperience = (id: string, data: any) =>
  axiosInstance.put(`/v1/experience/update/${id}`, data);
...
export const updateHome = (id: string, data: any) =>
  axiosInstance.put(`/v1/home/update/${id}`, data);
...
export const updatePage = (id: string, data: any) =>
  axiosInstance.put(`/v1/page/update/${id}`, data);
